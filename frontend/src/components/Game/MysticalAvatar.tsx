...
const avatarDesigns = [
  ...
  (isSelected: boolean) => (
    <g>
      <path d="M32 8 C16 8 8 24 8 40 L8 56 L56 56 L56 40 C56 24 48 8 32 8Z"
        className="fill-indigo-900/60 stroke-indigo-400/50" strokeWidth="1.5"/>
      <path d="M20 48 Q32 56 44 48" className="stroke-indigo-400/40 fill-none" strokeWidth="1.5"/>
      <ellipse cx="24" cy="32" rx="4" ry="3" className={`${isSelected ? 'fill-cyan-400' : 'fill-indigo-400/50'} transition-all duration-500`}>
        {isSelected && <animate attributeName="opacity" values="0.5;1;0.5" dur="2s" repeatCount="indefinite"/>}
      </ellipse>
      <ellipse cx="40" cy="32" rx="4" ry="3" className={`${isSelected ? 'fill-cyan-400' : 'fill-indigo-400/50'} transition-all duration-500`}>
        {isSelected && <animate attributeName="opacity" values="0.5;1;0.5" dur="2s" repeatCount="indefinite"/>}
      </ellipse>
  ...
  (isSelected: boolean) => (
    <g>
      <path d="M32 4 L24 16 L16 12 L20 24 L12 28 L20 32 L16 44 L24 40 L32 52 L40 40 L48 44 L44 32 L52 28 L44 24 L48 12 L40 16 Z"
        className="fill-indigo-900/50 stroke-yellow-500/60" strokeWidth="1.5"/>
      <circle cx="26" cy="28" r="4" className="fill-indigo-950 stroke-indigo-300/60" strokeWidth="1"/>
      <circle cx="38" cy="28" r="4" className="fill-indigo-950 stroke-indigo-300/60" strokeWidth="1"/>
      <circle cx="26" cy="28" r="2" className={`${isSelected ? 'fill-yellow-400' : 'fill-indigo-400/40'}`}>
        {isSelected && <animate attributeName="r" values="1.5;2.5;1.5" dur="1.5s" repeatCount="indefinite"/>}
      </circle>
      <circle cx="38" cy="28" r="2" className={`${isSelected ? 'fill-yellow-400' : 'fill-indigo-400/40'}`}>
        {isSelected && <animate attributeName="r" values="1.5;2.5;1.5" dur="1.5s" repeatCount="indefinite"/>}
      </circle>
    </g>
  ),
  ...
  (isSelected: boolean) => (
    <g>
      ...
      <path d="M20 16 Q32 8 44 16 L48 52 Q32 48 16 52 Z" className="fill-indigo-900/70 stroke-purple-400/50" strokeWidth="1.5">
      ...
      <circle cx="28" cy="28" r="3" className={`${isSelected ? 'fill-purple-400' : 'fill-indigo-400/40'}`}/>
      <circle cx="36" cy="28" r="3" className={`${isSelected ? 'fill-purple-400' : 'fill-indigo-400/40'}`}/>
  ...
  (isSelected: boolean) => (
    <g>
      <ellipse cx="32" cy="32" rx="22" ry="26" className="fill-indigo-900/50 stroke-indigo-400/60" strokeWidth="2"/>
      <path d="M18 26 L26 26 L26 34 L18 34 Z" className="fill-indigo-950 stroke-cyan-400/50" strokeWidth="1"/>
      <path d="M38 26 L46 26 L46 34 L38 34 Z" className="fill-indigo-950 stroke-cyan-400/50" strokeWidth="1"/>
      <rect x="21" y="28" width="4" height="4" className={`${isSelected ? 'fill-cyan-400' : 'fill-indigo-400/40'}`}>
        {isSelected && <animate attributeName="opacity" values="0.6;1;0.6" dur="1s" repeatCount="indefinite"/>}
      </rect>
      <rect x="39" y="28" width="4" height="4" className={`${isSelected ? 'fill-cyan-400' : 'fill-indigo-400/40'}`}>
        {isSelected && <animate attributeName="opacity" values="0.6;1;0.6" dur="1s" repeatCount="indefinite"/>}
      </rect>
      <path d="M26 44 Q32 50 38 44" className="stroke-indigo-400/40 fill-none" strokeWidth="2"/>
      <path d="M32 8 L32 4 M24 10 L22 6 M40 10 L42 6" className="stroke-yellow-500/50" strokeWidth="2"/>
    </g>
  ),
  ...
  (isSelected: boolean) => (
    <g>
      <path d="M32 12 C20 12 14 24 14 36 C14 48 20 54 32 54 C44 54 50 48 50 36 C50 24 44 12 32 12"
        className="fill-indigo-900/40 stroke-purple-500/50" strokeWidth="1.5"/>
      <ellipse cx="26" cy="30" rx="5" ry="4" className="fill-indigo-950"/>
      <ellipse cx="38" cy="30" rx="5" ry="4" className="fill-indigo-950"/>
      <circle cx="26" cy="30" r="2" className={`${isSelected ? 'fill-pink-400' : 'fill-indigo-400/40'}`}/>
      <circle cx="38" cy="30" r="2" className={`${isSelected ? 'fill-pink-400' : 'fill-indigo-400/40'}`}/>
      {isSelected && <>
  ...
  (isSelected: boolean) => (
    <g>
      <path d="M32 52 L20 44 L16 28 L20 16 L32 12 L44 16 L48 28 L44 44 Z"
        className="fill-indigo-900/60 stroke-orange-400/50" strokeWidth="1.5"/>
      ...
      <circle cx="26" cy="28" r="4" className="fill-indigo-950 stroke-orange-300/50" strokeWidth="1"/>
      <circle cx="38" cy="28" r="4" className="fill-indigo-950 stroke-orange-300/50" strokeWidth="1"/>
      <circle cx="26" cy="28" r="2" className={`${isSelected ? 'fill-orange-400' : 'fill-indigo-400/40'}`}>
        {isSelected && <animate attributeName="opacity" values="0.5;1;0.5" dur="0.8s" repeatCount="indefinite"/>}
      </circle>
      <circle cx="38" cy="28" r="2" className={`${isSelected ? 'fill-orange-400' : 'fill-indigo-400/40'}`}>
        {isSelected && <animate attributeName="opacity" values="0.5;1;0.5" dur="0.8s" repeatCount="indefinite"/>}
      </circle>
  ...
  (isSelected: boolean) => (
    <g>
      <ellipse cx="32" cy="6" rx="12" ry="3" className={`fill-none ${isSelected ? 'stroke-yellow-400' : 'stroke-yellow-400/30'}`} strokeWidth="2">
        {isSelected && <animate attributeName="stroke-opacity" values="0.5;1;0.5" dur="2s" repeatCount="indefinite"/>}
      </ellipse>
      <ellipse cx="32" cy="34" rx="18" ry="22" className="fill-indigo-900/50 stroke-indigo-400/50" strokeWidth="1.5"/>
      <path d="M24 28 Q26 24 28 28 Q26 32 24 28" className="fill-indigo-950 stroke-indigo-300/60" strokeWidth="1"/>
      <path d="M36 28 Q38 24 40 28 Q38 32 36 28" className="fill-indigo-950 stroke-indigo-300/60" strokeWidth="1"/>
      <ellipse cx="26" cy="28" rx="1.5" ry="2" className={`${isSelected ? 'fill-yellow-300' : 'fill-indigo-400/40'}`}/>
      <ellipse cx="38" cy="28" rx="1.5" ry="2" className={`${isSelected ? 'fill-yellow-300' : 'fill-indigo-400/40'}`}/>
  ...
  (isSelected: boolean) => (
    <g>
      <path d="M32 8 C18 8 10 20 10 34 C10 48 18 56 32 56 C46 56 54 48 54 34 C54 20 46 8 32 8"
        className="fill-gray-900/80 stroke-indigo-500/40" strokeWidth="1.5">
      ...
      <ellipse cx="24" cy="28" rx="6" ry="8" className="fill-indigo-950"/>
      <ellipse cx="40" cy="28" rx="6" ry="8" className="fill-indigo-950"/>
      <ellipse cx="24" cy="28" rx="2" ry="4" className={`${isSelected ? 'fill-red-500' : 'fill-indigo-400/30'}`}>
        {isSelected && <animate attributeName="ry" values="3;5;3" dur="2s" repeatCount="indefinite"/>}
      </ellipse>
      <ellipse cx="40" cy="28" rx="2" ry="4" className={`${isSelected ? 'fill-red-500' : 'fill-indigo-400/30'}`}>
        {isSelected && <animate attributeName="ry" values="3;5;3" dur="2s" repeatCount="indefinite"/>}
      </ellipse>
    </g>
  ),
  ...
  (isSelected: boolean) => (
    <g>
      <polygon points="32,4 48,20 48,44 32,60 16,44 16,20"
        className="fill-indigo-900/40 stroke-cyan-400/50" strokeWidth="1.5"/>
      <polygon points="32,12 42,22 42,42 32,52 22,42 22,22"
        className="fill-indigo-950/60 stroke-cyan-300/30" strokeWidth="1"/>
      <circle cx="26" cy="28" r="3" className={`${isSelected ? 'fill-cyan-400' : 'fill-indigo-400/40'}`}>
        {isSelected && <animate attributeName="opacity" values="0.6;1;0.6" dur="1.2s" repeatCount="indefinite"/>}
      </circle>
      <circle cx="38" cy="28" r="3" className={`${isSelected ? 'fill-cyan-400' : 'fill-indigo-400/40'}`}>
        {isSelected && <animate attributeName="opacity" values="0.6;1;0.6" dur="1.2s" repeatCount="indefinite"/>}
      </circle>
  ...
  (isSelected: boolean) => (
    <g>
      <circle cx="32" cy="32" r="20" className="fill-indigo-950/80 stroke-purple-500/50" strokeWidth="1.5"/>
      ...
      <ellipse cx="26" cy="28" rx="3" ry="4" className="fill-indigo-950"/>
      <ellipse cx="38" cy="28" rx="3" ry="4" className="fill-indigo-950"/>
      <circle cx="26" cy="28" r="1.5" className={`${isSelected ? 'fill-purple-400' : 'fill-indigo-400/30'}`}/>
      <circle cx="38" cy="28" r="1.5" className={`${isSelected ? 'fill-purple-400' : 'fill-indigo-400/30'}`}/>
      {isSelected && <>
