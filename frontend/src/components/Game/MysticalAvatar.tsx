...
const avatarDesigns = [
  ...
  (isSelected: boolean) => (
    <g className="animate-float-slow">
      <path d="M32 8 C16 8 8 24 8 40 L8 56 L56 56 L56 40 C56 24 48 8 32 8Z"
        className="fill-gray-900 stroke-cyan-500/50" strokeWidth="1.5"/>
      <path d="M20 48 Q32 56 44 48" className="stroke-cyan-400/40 fill-none" strokeWidth="1.5"/>
      <ellipse cx="24" cy="32" rx="4" ry="3" className={`${isSelected ? 'fill-cyan-400 filter url(#glow-filter)' : 'fill-cyan-400/50'} transition-all duration-500`}>
        {isSelected && <animate attributeName="opacity" values="0.5;1;0.5" dur="2s" repeatCount="indefinite"/>}
      </ellipse>
      <ellipse cx="40" cy="32" rx="4" ry="3" className={`${isSelected ? 'fill-cyan-400 filter url(#glow-filter)' : 'fill-cyan-400/50'} transition-all duration-500`}>
        {isSelected && <animate attributeName="opacity" values="0.5;1;0.5" dur="2s" repeatCount="indefinite"/>}
      </ellipse>
      <path d="M12 20 Q32 4 52 20" className="stroke-teal-400/30 fill-none" strokeWidth="2"/>
    </g>
  ),
  ...
  (isSelected: boolean) => (
    <g className="animate-float-slow" style={{ animationDelay: '0.5s' }}>
      ...
      <circle cx="26" cy="28" r="4" className="fill-gray-950 stroke-cyan-300/60" strokeWidth="1"/>
      <circle cx="38" cy="28" r="4" className="fill-gray-950 stroke-cyan-300/60" strokeWidth="1"/>
      <circle cx="26" cy="28" r="2" className={`${isSelected ? 'fill-amber-400 filter url(#glow-filter)' : 'fill-cyan-400/40'}`}>
        {isSelected && <animate attributeName="r" values="1.5;2.5;1.5" dur="1.5s" repeatCount="indefinite"/>}
      </circle>
      <circle cx="38" cy="28" r="2" className={`${isSelected ? 'fill-amber-400 filter url(#glow-filter)' : 'fill-cyan-400/40'}`}>
        {isSelected && <animate attributeName="r" values="1.5;2.5;1.5" dur="1.5s" repeatCount="indefinite"/>}
      </circle>
    </g>
  ),
  ...
  (isSelected: boolean) => (
    <g className="animate-float-slow" style={{ animationDelay: '1s' }}>
      <ellipse cx="32" cy="48" rx="16" ry="4" className="fill-cyan-900/30">
        {isSelected && <animate attributeName="ry" values="4;6;4" dur="3s" repeatCount="indefinite"/>}
      </ellipse>
      <path d="M20 16 Q32 8 44 16 L48 52 Q32 48 16 52 Z" className="fill-gray-900 stroke-teal-400/50" strokeWidth="1.5">
      ...
      <circle cx="28" cy="28" r="3" className={`${isSelected ? 'fill-teal-400 filter url(#glow-filter)' : 'fill-cyan-400/40'}`}/>
      <circle cx="36" cy="28" r="3" className={`${isSelected ? 'fill-teal-400 filter url(#glow-filter)' : 'fill-cyan-400/40'}`}/>
      {isSelected && <circle cx="32" cy="20" r="8" className="fill-teal-400/20">
  ...
  (isSelected: boolean) => (
    <g className="animate-float-slow" style={{ animationDelay: '1.5s' }}>
      <ellipse cx="32" cy="32" rx="22" ry="26" className="fill-gray-900 stroke-cyan-400/60" strokeWidth="2"/>
      ...
      <rect x="21" y="28" width="4" height="4" className={`${isSelected ? 'fill-cyan-400 filter url(#glow-filter)' : 'fill-cyan-400/40'}`}>
        {isSelected && <animate attributeName="opacity" values="0.6;1;0.6" dur="1s" repeatCount="indefinite"/>}
      </rect>
      <rect x="39" y="28" width="4" height="4" className={`${isSelected ? 'fill-cyan-400 filter url(#glow-filter)' : 'fill-cyan-400/40'}`}>
        {isSelected && <animate attributeName="opacity" values="0.6;1;0.6" dur="1s" repeatCount="indefinite"/>}
      </rect>
      <path d="M26 44 Q32 50 38 44" className="stroke-cyan-400/40 fill-none" strokeWidth="2"/>
  ...
  (isSelected: boolean) => (
    <g className="animate-float-slow" style={{ animationDelay: '2s' }}>
      <path d="M32 12 C20 12 14 24 14 36 C14 48 20 54 32 54 C44 54 50 48 50 36 C50 24 44 12 32 12"
        className="fill-gray-900 stroke-teal-500/50" strokeWidth="1.5"/>
      <ellipse cx="26" cy="30" rx="5" ry="4" className="fill-gray-950"/>
      <ellipse cx="38" cy="30" rx="5" ry="4" className="fill-gray-950"/>
      <circle cx="26" cy="30" r="2" className={`${isSelected ? 'fill-amber-400 filter url(#glow-filter)' : 'fill-cyan-400/40'}`}/>
      <circle cx="38" cy="30" r="2" className={`${isSelected ? 'fill-amber-400 filter url(#glow-filter)' : 'fill-cyan-400/40'}`}/>
      {isSelected && <>
        <circle cx="32" cy="32" r="28" className="fill-none stroke-teal-400/30" strokeWidth="1" strokeDasharray="4 4">
          <animateTransform attributeName="transform" type="rotate" from="0 32 32" to="360 32 32" dur="8s" repeatCount="indefinite"/>
        </circle>
        <circle cx="32" cy="32" r="24" className="fill-none stroke-amber-400/20" strokeWidth="1" strokeDasharray="2 6">
  ...
  (isSelected: boolean) => (
    <g className="animate-float-slow" style={{ animationDelay: '2.5s' }}>
      ...
      <circle cx="26" cy="28" r="2" className={`${isSelected ? 'fill-orange-400 filter url(#glow-filter)' : 'fill-cyan-400/40'}`}>
        {isSelected && <animate attributeName="opacity" values="0.5;1;0.5" dur="0.8s" repeatCount="indefinite"/>}
      </circle>
      <circle cx="38" cy="28" r="2" className={`${isSelected ? 'fill-orange-400 filter url(#glow-filter)' : 'fill-cyan-400/40'}`}>
        {isSelected && <animate attributeName="opacity" values="0.5;1;0.5" dur="0.8s" repeatCount="indefinite"/>}
      </circle>
  ...
  (isSelected: boolean) => (
    <g className="animate-float-slow" style={{ animationDelay: '3s' }}>
      ...
      <ellipse cx="32" cy="34" rx="18" ry="22" className="fill-gray-900 stroke-cyan-400/50" strokeWidth="1.5"/>
      <path d="M24 28 Q26 24 28 28 Q26 32 24 28" className="fill-gray-950 stroke-cyan-300/60" strokeWidth="1"/>
      <path d="M36 28 Q38 24 40 28 Q38 32 36 28" className="fill-gray-950 stroke-cyan-300/60" strokeWidth="1"/>
      <ellipse cx="26" cy="28" rx="1.5" ry="2" className={`${isSelected ? 'fill-yellow-300 filter url(#glow-filter)' : 'fill-cyan-400/40'}`}/>
      <ellipse cx="38" cy="28" rx="1.5" ry="2" className={`${isSelected ? 'fill-yellow-300 filter url(#glow-filter)' : 'fill-cyan-400/40'}`}/>
      <path d="M28 42 Q32 46 36 42" className="stroke-cyan-400/30 fill-none" strokeWidth="1.5"/>
    </g>
  ),
  ...
  (isSelected: boolean) => (
    <g className="animate-float-slow" style={{ animationDelay: '3.5s' }}>
      <path d="M32 8 C18 8 10 20 10 34 C10 48 18 56 32 56 C46 56 54 48 54 34 C54 20 46 8 32 8"
        className="fill-gray-900 stroke-cyan-500/40" strokeWidth="1.5">
      ...
      <ellipse cx="24" cy="28" rx="2" ry="4" className={`${isSelected ? 'fill-amber-500 filter url(#glow-filter)' : 'fill-cyan-400/30'}`}>
        {isSelected && <animate attributeName="ry" values="3;5;3" dur="2s" repeatCount="indefinite"/>}
      </ellipse>
      <ellipse cx="40" cy="28" rx="2" ry="4" className={`${isSelected ? 'fill-amber-500 filter url(#glow-filter)' : 'fill-cyan-400/30'}`}>
        {isSelected && <animate attributeName="ry" values="3;5;3" dur="2s" repeatCount="indefinite"/>}
      </ellipse>
    </g>
  ),
  ...
  (isSelected: boolean) => (
    <g className="animate-float-slow" style={{ animationDelay: '4s' }}>
      ...
      <circle cx="26" cy="28" r="3" className={`${isSelected ? 'fill-cyan-400 filter url(#glow-filter)' : 'fill-cyan-400/40'}`}>
        {isSelected && <animate attributeName="opacity" values="0.6;1;0.6" dur="1.2s" repeatCount="indefinite"/>}
      </circle>
      <circle cx="38" cy="28" r="3" className={`${isSelected ? 'fill-cyan-400 filter url(#glow-filter)' : 'fill-cyan-400/40'}`}>
        {isSelected && <animate attributeName="opacity" values="0.6;1;0.6" dur="1.2s" repeatCount="indefinite"/>}
      </circle>
  ...
  (isSelected: boolean) => (
    <g className="animate-float-slow" style={{ animationDelay: '4.5s' }}>
      <circle cx="32" cy="32" r="20" className="fill-gray-950 stroke-teal-500/50" strokeWidth="1.5"/>
      <circle cx="32" cy="32" r="14" className="fill-gray-900 stroke-teal-400/30" strokeWidth="1">
      ...
      <circle cx="26" cy="28" r="1.5" className={`${isSelected ? 'fill-teal-400 filter url(#glow-filter)' : 'fill-cyan-400/30'}`}/>
      <circle cx="38" cy="28" r="1.5" className={`${isSelected ? 'fill-teal-400 filter url(#glow-filter)' : 'fill-cyan-400/30'}`}/>
      {isSelected && <>
        <circle cx="32" cy="32" r="22" className="fill-none stroke-teal-500/30" strokeWidth="1">
          <animate attributeName="r" values="20;24;20" dur="2s" repeatCount="indefinite"/>
          <animate attributeName="stroke-opacity" values="0.3;0.1;0.3" dur="2s" repeatCount="indefinite"/>
        </circle>
      </>}
      <path d="M28 40 Q32 44 36 40" className="stroke-teal-400/40 fill-none" strokeWidth="1.5"/>
    </g>
  ),
];
